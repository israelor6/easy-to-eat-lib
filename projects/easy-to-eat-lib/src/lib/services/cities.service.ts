...
export class CitiesService {
  ...
  apiURL = 'https://data.gov.il/api/action/datastore_search?resource_id=d4901968-dad3-4845-a9b0-a57d027f11ab&limit=2000';
  city: City[];
  ...
  getAllCities(): any {
    ...
    const a = // 20190807134213
// https://data.gov.il/api/action/datastore_search?resource_id=d4901968-dad3-4845-a9b0-a57d027f11ab&limit=2000

      {
        ...
        "result": {
          ...
          "limit": 2000,
          "_links": {
            "start": "/api/action/datastore_search?limit=2000&resource_id=d4901968-dad3-4845-a9b0-a57d027f11ab",
            "next": "/api/action/datastore_search?offset=2000&limit=2000&resource_id=d4901968-dad3-4845-a9b0-a57d027f11ab"
          },
          "total": 1272
        }
      }
